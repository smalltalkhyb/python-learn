...
from apps.infrastructure.utils import ssrf_proxy
from apps.infrastructure.utils.store.ext_storage import storage
from apps.service.grap.models.file_model import FileAttribute, File, FileType, FileTransferMethod
from apps.service.grap.models.image_model import ImagePromptMessageContent, MultiModalPromptMessageContent
...
def to_prompt_message_content(
    ...
    *,
    ...
    params = {
        "base64_data": _get_encoded_string(f) if settings.settings.MULTIMODAL_SEND_FORMAT == "base64" else "",
        "url": _to_url(f) if settings.settings.MULTIMODAL_SEND_FORMAT == "url" else "",
...
def _to_url(f: File, /, ToolFileParser=None):
