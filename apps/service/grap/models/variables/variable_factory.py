...
import settings
from apps.service.grap.models.file_model import File
from apps.service.grap.models.variables.segments import (
    ArrayAnySegment,
    ArrayFileSegment,
    ArrayNumberSegment,
    ArrayObjectSegment,
...
from apps.service.grap.models.variables.types import SegmentType
from apps.service.grap.models.variables.variables import (
    ArrayAnyVariable,
    ArrayFileVariable,
    ArrayNumberVariable,
    ArrayObjectVariable,
...
from apps.service.grap.models.variables.variables_constants import CONVERSATION_VARIABLE_NODE_ID, \
...
def _build_variable_from_mapping(*, mapping: Mapping[str, Any], selector: Sequence[str]) -> Variable:
    ...
    if result.size > settings.settings.MAX_VARIABLE_SIZE:
        raise VariableError(f"variable size {result.size} exceeds limit {settings.settings.MAX_VARIABLE_SIZE}")
