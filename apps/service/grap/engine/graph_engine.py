...
import settings
from apps.service.grap.default_type_value import BaseNodeData, ErrorStrategy
from apps.service.grap.engine.base_stream_processor import StreamProcessor
from apps.service.grap.engine.condition_handlers.condition_manager import ConditionManager
from apps.service.grap.engine.end_stream_processor import EndStreamProcessor
from apps.service.grap.engine.workflow_type import WorkflowType, WorkflowNodeExecutionStatus
from apps.service.grap.event.event import RunCompletedEvent, RunStreamChunkEvent, RunRetrieverResourceEvent
from apps.service.grap.graph import Graph, GraphEdge
from apps.service.grap.models.event import GraphRunStartedEvent, GraphEngineEvent, NodeRunFailedEvent, \
    GraphRunFailedEvent, NodeRunSucceededEvent, GraphRunPartialSucceededEvent, GraphRunSucceededEvent, \
    NodeRunStartedEvent, BaseAgentEvent, ParallelBranchRunSucceededEvent, ParallelBranchRunFailedEvent, \
    ParallelBranchRunStartedEvent, BaseIterationEvent, BaseLoopEvent, NodeRunRetryEvent, NodeRunExceptionEvent, \
    NodeRunStreamChunkEvent, NodeRunRetrieverResourceEvent
...
from apps.service.grap.models.node_entities import AgentNodeStrategyInit, NodeRunMetadataKey, NodeRunResult
from apps.service.grap.models.node_mapping import NODE_TYPE_CLASSES_MAPPING
...
from apps.service.grap.models.variable_pool import VariablePool, VariableValue
from apps.service.grap.node_type import NodeType, FailBranchSourceHandle
...
class GraphEngine:
    ...
    def __init__(
        ...
        thread_pool_max_submit_count = settings.settings.MAX_SUBMIT_COUNT
    ...
    def _run_node(
        ...
        while should_continue_retry and retries <= max_retries:
            try:
                # run node
                retry_start_at = datetime.now().replace(tzinfo=None)
                        ...
                        if isinstance(item, RunCompletedEvent):
                            ...
                            if run_result.status == WorkflowNodeExecutionStatus.FAILED:
                                ...
                                if (
                                    ...
                                    run_result.edge_source_handle = FailBranchSourceHandle.SUCCESS.value
